...
function SpawnPalletsAtSiloEvent.new(aPalletSilo, ownerFarmId, fillUnitIndex, pendingLiters, fillTypeIndex, isBale, isRoundbale, width, height, length, diameter, capacity, wrapState, customEnvironment)
...
function SpawnPalletsAtSiloEvent.sendEvent(aPalletSilo, ownerFarmId, fillUnitIndex, pendingLiters, fillTypeIndex, isBale, isRoundbale, width, height, length, diameter, capacity, wrapState, customEnvironment)
    g_client:getServerConnection():sendEvent(SpawnPalletsAtSiloEvent.new(aPalletSilo, ownerFarmId, fillUnitIndex, pendingLiters, fillTypeIndex, isBale, isRoundbale, width, height, length, diameter, capacity, wrapState, customEnvironment))
end